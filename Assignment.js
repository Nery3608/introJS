...
Names: Nery__  Neil__________________  (______________________)
...
// Let the city be named and identified as Indianapolis
let city = "Indianapolis";

// TODO comment: ________________________________________________
// Print out the city and its name
...
let firstName = "Nery";
let lastName = "Estudillo";
let classPeriod = "2nd Period";
...
// 7a) let 2cool = "nope";        // YES / NO: ___No____
// 7b) let my_name = "ok";        // YES / NO: ___Yes____
// 7c) let class = "reserved";    // YES / NO: ____No___
// 7d) let firstName = "ok";      // YES / NO: ____Yes___
// 7e) let $total = 10;           // YES / NO: ____Yes___
...
let studentOne = "Atlas";
let studentTwo = "Broto";
const assignmentName = "Mlawm-Bomb";
